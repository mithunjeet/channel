...
export default function JobSeekerDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white p-6">
      <div className="max-w-6xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-8 border border-blue-100">

        {/* Profile Header */}


        <div className="text-center space-y-2">
          <h1 className="text-4xl font-bold text-blue-700">Your Dashboard</h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-center">
          ...
          >
            ...
            <p className="text-sm text-gray-500 mt-1">Saved learning videos</p>
          </div>
          ...
          >
            ...
            <p className="text-sm text-gray-500 mt-1">Update profile & more</p>
          </div>
        </div>

        {/* Applied Jobs Section */}
        <div className="mt-8">
          <h2 className="text-2xl font-semibold text-blue-700 mb-4 text-center underline">All Jobs You Applied</h2>
          {job.length === 0 ? (
